var UIController = (function() {
    ...
    function displayRightAnswer() {
        document.querySelector(DOMstrings.correctBanner).className = "banner correct visible";  
    }
    ...
    function displayNewQuestion(num) {
        ...
        document.querySelector(DOMstrings.answerA).textContent = questionController.getQuestion(num).a;
        document.querySelector(DOMstrings.answerB).textContent = questionController.getQuestion(num).b;
        document.querySelector(DOMstrings.answerC).textContent = questionController.getQuestion(num).c;
        document.querySelector(DOMstrings.answerD).textContent = questionController.getQuestion(num).d;
   ...
   function updateScore(score, correctResponses, wrongResponses) {
        document.querySelector(DOMstrings.playerScore).textContent = score;
        document.querySelector(DOMstrings.qRight).textContent = correctResponses;
        document.querySelector(DOMstrings.qWrong).textContent = wrongResponses;
   }
